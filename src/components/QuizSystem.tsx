...
export const grandFinalExam: QuizQuestion[] = [
  ...
  {
    id: 111,
    question: "ما هي السورة الكريمة التي يُطلق عليها في الأثر المأثور 'عروس القرآن'؟",
    options: ["سورة الرحمن", "سورة يس", "سورة الملك", "سورة الواقعة"],
    correctAnswer: 0,
    explanation: "سورة الرحمن تلقب بعروس القرآن لما تحويه من نعم ظاهرة وباطنة وتجلي عظمة الخالق وإبداع صنعه."
  },
  {
    id: 112,
    question: "أي من الآتية تُعد من المعجزات الباهرة التي أيد الله بها نبيّه عيسى عليه السلام؟",
    options: ["انشقاق القمر لفرقين", "إبراء الأكمه والأبرص وإحياء الموتى بإذن الله تعالى", "خروج ناقة عظيمة من الصخر الأصم", "عدم تأثره بنيران النمرود الملتهبة"],
    correctAnswer: 1,
    explanation: "عيسى عليه السلام أيّده الله تعالى بمعجزات طبية وإعجازية عظيمة كإحياء الموتى وإبراء الأبرص للمطابقة مع علم قومه."
  },
  {
    id: 113,
    question: "ما معنى الكلمة القرآنية 'يُزْجِي' في قوله تعالى: (أَلَمْ تَرَ أَنَّ اللَّهَ يُزْجِي سَحَابًا)؟",
    options: ["يمطره بغزارة", "يقسمه شذر مذر", "يسوقه ويدفعه برفق وعناية ليتراكم ثم ينزل المطر", "يفتته ويتلفه بالصواعق"],
    correctAnswer: 2,
    explanation: "الإزجاء هو السوق والترقية برفق لتكوين سحب ركامية ممطرة تنفع العباد والبلاد."
  },
  {
    id: 114,
